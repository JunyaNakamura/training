...
import jp.genuine.training.scheduler.base.datasource.infrastructure.mybatis.LocalDateHandler;
import jp.genuine.training.scheduler.base.datasource.infrastructure.mybatis.LocalDateTimeHandler;


public class MyBatisConfig {

	@Configuration
	@MapperScan(basePackages = {"jp.genuine.training.scheduler.datasource.sampledb"}, sqlSessionFactoryRef = "sampleSqlSessionFactory")
